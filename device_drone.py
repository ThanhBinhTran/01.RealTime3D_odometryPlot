...
class Quadrotor():
    ...
    def plot_devices(self, ax):  # pragma: no cover
    ...
    def plot_devices_2D(self, ax):  # pragma: no cover
        T = self.transformation_matrix()
        ...
        ax.plot([p1_t[0], p2_t[0]], [p1_t[1], p2_t[1]], 'r-')
        ax.plot([p3_t[0], p4_t[0]], [p3_t[1], p4_t[1]], 'r-')
